    ...
    <div className="min-h-screen bg-white relative overflow-hidden p-8">
      ...
      <main className="max-w-2xl mx-auto mt-24 text-center px-4 z-10 relative">
        ...
        <div className="flex justify-center space-x-4">
          <Link to={"/products"} className="px-8 py-3 bg-white border border-gray-300 rounded-full text-sm">
            Shop Now
          </Link>
          <Link to={"/products"} className="px-8 py-3 bg-white border border-gray-300 rounded-full text-sm flex items-center">
